...
/**
 * Object to represent the "locallyAddedAssertions" property at a SLURM JSON
 *
 */
public class SlurmAssertions {

	/**
	 * List of prefixAssertions
	 */
	private List<SlurmPrefix> prefixes;

	/**
	 * List of bgpsecAssertions
	 */
	...
	public String toString() {
		...
		sb.append(SlurmAssertions.class.getName());
		sb.append("[");
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof SlurmAssertions))
			return false;
		SlurmAssertions other = (SlurmAssertions) obj;
		if (prefixes == null) {
